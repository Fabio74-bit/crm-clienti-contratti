...
index 3495ac3ab538ddc5d26e4f36eb6d72e5e20f9765..7b2588ff68843ed597db66db6c063eb0f53a9a4d 100644
--- a/app.py
+++ b/app.py
@@ -1,161 +1,233 @@
...
+    )
 ...
 def page_dashboard(df_cli, df_ct, role):
     ...
     st.divider()
@@ -181,72 +253,72 @@ def page_dashboard(df_cli, df_ct, role):
...
@@ -342,97 +414,96 @@ def page_clienti(df_cli: pd.DataFrame, df_ct: pd.DataFrame, role: str):
...
+            save_preventivi(df_prev)
 ...
 # ==========================
@@ -441,61 +512,71 @@ def _parse_italian_date(value):
         return None
     try:
...
@@ -605,52 +686,50 @@ def page_contratti(df_cli: pd.DataFrame, df_ct: pd.DataFrame, role: str):
